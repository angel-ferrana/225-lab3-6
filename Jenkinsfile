pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/ferrana'                                                                    //<------change this
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/angel-ferrana/225-lab3-6.git'                                          //<------change this
        KUBECONFIG = credentials('ferrana-225')                                                         //<------change this
    }
